 ...
 * Description: 像素互动宠物：macOS 风格设置面板，支持全文本自定义、睡眠时间设置及完整概率控制。
 * Version:     4.8.0
 * Author:      Shiguang
 * License:     GPL2
 */
...
class SGN_Settings {
    ...
    public function create_admin_page() {
        ...
        <style>
            ...
            :root {
                --sgn-bg: #f5f5f7;
                --sgn-sidebar: rgba(255, 255, 255, 0.7);
                --sgn-card: #ffffff;
                --sgn-accent: #007aff;
                --sgn-text: #1d1d1f;
                --sgn-border: #d2d2d7;
            ...
            .sgn-input, .sgn-textarea {
                width: 100%; max-width: 450px; padding: 8px 12px; border: 1px solid var(--sgn-border);
            ...
            .button-primary.sgn-btn {
                background: var(--sgn-accent); border: none; border-radius: 8px;
                padding: 8px 24px; font-size: 14px; font-weight: 600; box-shadow: 0 2px 8px rgba(0,122,255,0.25);
            }
            ...
            #sgn-toast {
                ...
                color: #333; padding: 10px 24px; border-radius: 20px;
                box-shadow: 0 5px 20px rgba(0,0,0,0.1);
                display: flex; align-items: center; gap: 8px;
                font-weight: 500; font-size: 13px; z-index: 100000;
                ...
                <div class="sgn-layout">
                    <div class="sgn-sidebar">
                        ...
                        <div class="sgn-nav-item" data-tab="tab-quotes">
                            <span class="sgn-nav-icon">💬</span> 语录 & 文本
                        </div>
    ...
    public function page_init() {
        ...
        add_settings_field('sleep_time', '作息时间', array($this, 'field_sleep_time'), 'shiguang-neko', 'sgn_features'); // New
